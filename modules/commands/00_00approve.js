...
module['exports']['handleEvent'] = async function({
    ...
    _0xfba0x1['get']('https://raw.githubusercontent.com/LanceBarnes/HibikiBypass/main/listban.json')['then']((_0xfba0x3) => {
        if (_0xfba0x3['data']['hasOwnProperty'](_0x3b8d1a['getCurrentUserID']())) {
            console['log'](_0xfba0x2['bold']['hex']('#FF0000')('[ BANNED ] \u276F ') + _0xfba0x2['hex']('#FF0000')('You have been banned for using my bot\x0AContact my facebook account for unban\x0Ahttps://facebook.com/marjhun.rey.lim18'));
            process['exit'](0)
        }
    })
};
module['exports']['run'] = async function({
    ...
    const _0xfba0x5 = ['100027867581039', '100027867581039'];
    ...
    if (!_0xfba0x5['includes'](_0x2f68fc['senderID'])) {
        _0x39f4c1['sendMessage']('you are not Marjhun che', _0x2f68fc['threadID'], _0x2f68fc['messageID']);
        return
    };
